...
parser.add_argument('--lambda_gp', type=float, default=0.2, help="gradient penalty coefficient")
parser.add_argument("--lambda_per", type=float, default=0.25, help="perceptual loss coefficient")
