...
parser.add_argument("--total_iters", default=125, type=int, help="total epochs we're training for")
...
parser.add_argument("--lambda_GP", type=float, default=0.1, help="Gradient_penalty loss")
